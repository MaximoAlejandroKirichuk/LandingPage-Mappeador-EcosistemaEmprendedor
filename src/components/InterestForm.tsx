...
export function InterestForm({
    ...
    const formClassName = ['interest-form', className].filter(Boolean).join(' ')

    return (
        <form className={formClassName} style={style} onSubmit={handleSubmit}>
            ...
            {statusMessage && <p className={`form-status ${status}`}>{statusMessage}</p>}
        </form>
    )
}